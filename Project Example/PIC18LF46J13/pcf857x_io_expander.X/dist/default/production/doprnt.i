...
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        if (!strncmp(*fmt, "jd", ((sizeof("jd")/sizeof("jd"[0]))-1)) || !strncmp(*fmt, "ji", ((sizeof("ji")/sizeof("ji"[0]))-1))) {


            *fmt += ((sizeof("jd")/sizeof("jd"[0]))-1);
            ll = (long long)(*(intmax_t *)__va_arg(*(intmax_t **)ap, (intmax_t)0));
        ...
        if (!strncmp(*fmt, "llo", ((sizeof("llo")/sizeof("llo"[0]))-1))) {

            *fmt += ((sizeof("llo")/sizeof("llo"[0]))-1);
        ...
        if (!strncmp(*fmt, "jo", ((sizeof("jo")/sizeof("jo"[0]))-1))) {

            *fmt += ((sizeof("jo")/sizeof("jo"[0]))-1);
            llu = (unsigned long long)(*(uintmax_t *)__va_arg(*(uintmax_t **)ap, (uintmax_t)0));
        ...
        if (!strncmp(*fmt, "lln", ((sizeof("lln")/sizeof("lln"[0]))-1))) {

            *fmt += ((sizeof("lln")/sizeof("lln"[0]))-1);
            vp = (void *)(*(long long * *)__va_arg(*(long long * **)ap, (long long *)0));
        ...
        if (!strncmp(*fmt, "jn", ((sizeof("jn")/sizeof("jn"[0]))-1))) {

            *fmt += ((sizeof("jn")/sizeof("jn"[0]))-1);
            vp = (void *)(*(uintmax_t * *)__va_arg(*(uintmax_t * **)ap, (uintmax_t *)0));
   ...
   *fmt += *fmt[0] == 's' ? 1 : ((sizeof("lls")/sizeof("lls"[0]))-1);
        ...
        if (!strncmp(*fmt, "ju", ((sizeof("ju")/sizeof("ju"[0]))-1))) {

            *fmt += ((sizeof("ju")/sizeof("ju"[0]))-1);
            llu = (unsigned long long)(*(uintmax_t *)__va_arg(*(uintmax_t **)ap, (uintmax_t)0));
        ...
        if (!strncmp(*fmt, "jx", ((sizeof("jx")/sizeof("jx"[0]))-1)) || !strncmp(*fmt, "jX", ((sizeof("jX")/sizeof("jX"[0]))-1))) {


            c = (*fmt)[1];
            *fmt += ((sizeof("jx")/sizeof("jx"[0]))-1);
            llu = (unsigned long long)(*(uintmax_t *)__va_arg(*(uintmax_t **)ap, (uintmax_t)0));
